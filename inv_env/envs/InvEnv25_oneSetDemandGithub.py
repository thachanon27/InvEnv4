...
class InvEnv6(gym.Env):
    ...
    def step(self, action):
        ...
        holding = (overage1 * h1 + overage2 * h2 + overage3 * h3)/2  #holding devide by 2 cause holding cost rate is per day not per shift 
        ...
        demand_array2 = [3362.32, 2246.4, 1814.8, 0.0, 0.0, 0.0, 4469.08, 2427.36, 2420.96, 
                        0.0, 0.0, 0.0, 4428.8, 2825.68, 1479.92, 0.0, 0.0, 0.0, 2693.333333, 2006.0, 1454.666667, 
                        0.0, 0.0, 0.0, 2796.0, 2200.0, 1069.333333, 0.0, 0.0, 0.0, 3480.0, 2011.0, 1049.0,
                        0.0, 0.0, 0.0, 3232.0, 2513.333333, 1746.0, 0.0, 0.0, 0.0, 4489.5, 2334.0, 2424.0, 
                        0.0, 0.0, 0.0, 3233.0, 2160.0, 1745.0, 0.0, 0.0, 0.0, 3981.0, 2005.0, 1183.0, 0.0, 0.0, 0.0,
                        3107.692308, 2015.384615, 1678.461538, 0.0, 0.0, 0.0, 2796.0, 2200.0, 1069.333333, 
                        0.0, 0.0, 0.0, 2620.0, 2207.333333, 1032.666667, 0.0, 0.0, 0.0, 2654.666667, 2120.0, 1164.0,
                        0.0, 0.0, 0.0, 3232.0, 2180.0, 1746.0, 0, 0, 0]
        ...
        info = [self.CO_var_set1, self.CO_var_set2, self.sum_reward, last_sum_reward,last_sum_real_reward, self.sum_ex_penalty_array,
                d4, d5, d6, d7,
