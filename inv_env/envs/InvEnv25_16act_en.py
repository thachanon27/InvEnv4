...
class InvEnv4_en(gym.Env):
    def __init__(self):
        ...
        self.statelow = np.array([
            0, 0, 0,  # initial inventory             ##ตอนนี้  state จะมีค่าพารามอเตอร์ทั้งหมด = 28
    ...
    def step(self, action):
        ...
        demand6, demand7, demand8, demand9, extra_p_on, period = self.state
